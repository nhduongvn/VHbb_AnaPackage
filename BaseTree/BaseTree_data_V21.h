...
// Mon Mar 21 10:55:50 2016 by ROOT version 6.02/10
// from TChain tree/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         trgObjects_hltEle23WPLoose_pt[2];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_eta[2];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_phi[2];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_mass[2];   //[ntrgObjects_hltEle23WPLoose]
   ...
   Float_t         trgObjects_hltEle22eta2p1WPLoose_pt[2];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_eta[2];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_phi[2];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_mass[2];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   ...
   Float_t         trgObjects_hltIsoMu18_pt[2];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_eta[2];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_phi[2];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_mass[2];   //[ntrgObjects_hltIsoMu18]
   ...
   Float_t         trgObjects_l1Met_pt[1];   //[ntrgObjects_l1Met]
   Int_t           nGenJet;
   ...
   Float_t         trgObjects_l1ForwardJets_pt[2];   //[ntrgObjects_l1ForwardJets]
   ...
   Float_t         Jet_btagCMVA[17];   //[nJet]
   Float_t         Jet_rawPt[17];   //[nJet]
   Float_t         Jet_corr_JECUp[17];   //[nJet]
   Float_t         Jet_corr_JECDown[17];   //[nJet]
   Float_t         Jet_corr[17];   //[nJet]
   Float_t         Jet_pt[17];   //[nJet]
   Float_t         Jet_eta[17];   //[nJet]
   Float_t         Jet_phi[17];   //[nJet]
   Float_t         Jet_mass[17];   //[nJet]
   Float_t         Jet_rawPtAfterSmearing[17];   //[nJet]
   Int_t           Jet_idxFirstTauMatch[17];   //[nJet]
   Float_t         Jet_ctagVsL[17];   //[nJet]
   Float_t         Jet_ctagVsB[17];   //[nJet]
   Float_t         Jet_btagBDT[17];   //[nJet]
   Float_t         Jet_btagProb[17];   //[nJet]
   Float_t         Jet_btagBProb[17];   //[nJet]
   Float_t         Jet_btagSoftEl[17];   //[nJet]
   Float_t         Jet_btagSoftMu[17];   //[nJet]
   Float_t         Jet_btagnew[17];   //[nJet]
   Float_t         Jet_btagCSVV0[17];   //[nJet]
   Float_t         Jet_btagCMVAV2[17];   //[nJet]
   ...
   Int_t           Jet_chMult[17];   //[nJet]
   Int_t           Jet_nhMult[17];   //[nJet]
   Float_t         Jet_leadTrackPt[17];   //[nJet]
   Float_t         Jet_leptonPdgId[17];   //[nJet]
   Float_t         Jet_leptonPt[17];   //[nJet]
   Float_t         Jet_leptonPtRel[17];   //[nJet]
   Float_t         Jet_leptonPtRelInv[17];   //[nJet]
   Float_t         Jet_leptonDeltaR[17];   //[nJet]
   Float_t         Jet_leptonDeltaPhi[17];   //[nJet]
   Float_t         Jet_leptonDeltaEta[17];   //[nJet]
   Float_t         Jet_vtxMass[17];   //[nJet]
   Float_t         Jet_vtxNtracks[17];   //[nJet]
   Float_t         Jet_vtxPt[17];   //[nJet]
   Float_t         Jet_vtx3DSig[17];   //[nJet]
   Float_t         Jet_vtx3DVal[17];   //[nJet]
   Float_t         Jet_vtxPosX[17];   //[nJet]
   Float_t         Jet_vtxPosY[17];   //[nJet]
   Float_t         Jet_vtxPosZ[17];   //[nJet]
   Float_t         Jet_pullVectorPhi[17];   //[nJet]
   Float_t         Jet_pullVectorMag[17];   //[nJet]
   Float_t         Jet_qgl[17];   //[nJet]
   Float_t         Jet_ptd[17];   //[nJet]
   Float_t         Jet_axis2[17];   //[nJet]
   Int_t           Jet_mult[17];   //[nJet]
   Int_t           Jet_numberOfDaughters[17];   //[nJet]
   Int_t           Jet_btagIdx[17];   //[nJet]
   Int_t           Jet_mcIdx[17];   //[nJet]
   Float_t         Jet_blike_VBF[17];   //[nJet]
   Float_t         Jet_pt_reg[17];   //[nJet]
   Float_t         Jet_pt_regVBF[17];   //[nJet]
   Float_t         Jet_pt_reg_corrJECUp[17];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECUp[17];   //[nJet]
   Float_t         Jet_pt_reg_corrJECDown[17];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECDown[17];   //[nJet]
   Float_t         Jet_pt_reg_corrJERUp[17];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERUp[17];   //[nJet]
   Float_t         Jet_pt_reg_corrJERDown[17];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERDown[17];   //[nJet]
