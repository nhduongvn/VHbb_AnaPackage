...
// Mon Mar 21 12:22:47 2016 by ROOT version 6.02/10
// from TChain tree/
//////////////////////////////////////////////////////////
...
class BaseTree : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         trgObjects_hltEle23WPLoose_pt[3];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_eta[3];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_phi[3];   //[ntrgObjects_hltEle23WPLoose]
   Float_t         trgObjects_hltEle23WPLoose_mass[3];   //[ntrgObjects_hltEle23WPLoose]
   ...
   Float_t         trgObjects_hltEle22eta2p1WPLoose_pt[3];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_eta[3];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_phi[3];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   Float_t         trgObjects_hltEle22eta2p1WPLoose_mass[3];   //[ntrgObjects_hltEle22eta2p1WPLoose]
   ...
   Float_t         trgObjects_hltIsoMu18_pt[3];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_eta[3];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_phi[3];   //[ntrgObjects_hltIsoMu18]
   Float_t         trgObjects_hltIsoMu18_mass[3];   //[ntrgObjects_hltIsoMu18]
   Int_t           nGenLep;
   ...
   Int_t           GenHiggsSisters_pdgId[3];   //[nGenHiggsSisters]
   Float_t         GenHiggsSisters_pt[3];   //[nGenHiggsSisters]
   Float_t         GenHiggsSisters_eta[3];   //[nGenHiggsSisters]
   Float_t         GenHiggsSisters_phi[3];   //[nGenHiggsSisters]
   Float_t         GenHiggsSisters_mass[3];   //[nGenHiggsSisters]
   Float_t         GenHiggsSisters_charge[3];   //[nGenHiggsSisters]
   Int_t           GenHiggsSisters_status[3];   //[nGenHiggsSisters]
   Int_t           naLeptons;
   Int_t           aLeptons_charge[7];   //[naLeptons]
   Int_t           aLeptons_tightId[7];   //[naLeptons]
   Int_t           aLeptons_eleCutIdCSA14_25ns_v1[7];   //[naLeptons]
   Int_t           aLeptons_eleCutIdCSA14_50ns_v1[7];   //[naLeptons]
   Int_t           aLeptons_eleCutIdSpring15_25ns_v1[7];   //[naLeptons]
   Float_t         aLeptons_dxy[7];   //[naLeptons]
   Float_t         aLeptons_dz[7];   //[naLeptons]
   Float_t         aLeptons_edxy[7];   //[naLeptons]
   Float_t         aLeptons_edz[7];   //[naLeptons]
   Float_t         aLeptons_ip3d[7];   //[naLeptons]
   Float_t         aLeptons_sip3d[7];   //[naLeptons]
   Int_t           aLeptons_convVeto[7];   //[naLeptons]
   Int_t           aLeptons_lostHits[7];   //[naLeptons]
   Float_t         aLeptons_relIso03[7];   //[naLeptons]
   Float_t         aLeptons_relIso04[7];   //[naLeptons]
   Float_t         aLeptons_miniRelIso[7];   //[naLeptons]
   Float_t         aLeptons_relIsoAn04[7];   //[naLeptons]
   Int_t           aLeptons_tightCharge[7];   //[naLeptons]
   Int_t           aLeptons_mcMatchId[7];   //[naLeptons]
   Int_t           aLeptons_mcMatchAny[7];   //[naLeptons]
   Int_t           aLeptons_mcMatchTau[7];   //[naLeptons]
   Float_t         aLeptons_mcPt[7];   //[naLeptons]
   Int_t           aLeptons_mediumMuonId[7];   //[naLeptons]
   Int_t           aLeptons_pdgId[7];   //[naLeptons]
   Float_t         aLeptons_pt[7];   //[naLeptons]
   Float_t         aLeptons_eta[7];   //[naLeptons]
   Float_t         aLeptons_phi[7];   //[naLeptons]
   Float_t         aLeptons_mass[7];   //[naLeptons]
   Int_t           aLeptons_looseIdSusy[7];   //[naLeptons]
   Int_t           aLeptons_looseIdPOG[7];   //[naLeptons]
   Float_t         aLeptons_chargedHadRelIso03[7];   //[naLeptons]
   Float_t         aLeptons_chargedHadRelIso04[7];   //[naLeptons]
   Float_t         aLeptons_eleSieie[7];   //[naLeptons]
   Float_t         aLeptons_eleDEta[7];   //[naLeptons]
   Float_t         aLeptons_eleDPhi[7];   //[naLeptons]
   Float_t         aLeptons_eleHoE[7];   //[naLeptons]
   Float_t         aLeptons_eleMissingHits[7];   //[naLeptons]
   Float_t         aLeptons_eleChi2[7];   //[naLeptons]
   Int_t           aLeptons_convVetoFull[7];   //[naLeptons]
   Float_t         aLeptons_eleMVArawSpring15Trig[7];   //[naLeptons]
   Int_t           aLeptons_eleMVAIdSpring15Trig[7];   //[naLeptons]
   Float_t         aLeptons_eleMVArawSpring15NonTrig[7];   //[naLeptons]
   Int_t           aLeptons_eleMVAIdSpring15NonTrig[7];   //[naLeptons]
   Float_t         aLeptons_nStations[7];   //[naLeptons]
   Float_t         aLeptons_trkKink[7];   //[naLeptons]
   Float_t         aLeptons_segmentCompatibility[7];   //[naLeptons]
   Float_t         aLeptons_caloCompatibility[7];   //[naLeptons]
   Float_t         aLeptons_globalTrackChi2[7];   //[naLeptons]
   Float_t         aLeptons_nChamberHits[7];   //[naLeptons]
   Float_t         aLeptons_isPFMuon[7];   //[naLeptons]
   Float_t         aLeptons_isGlobalMuon[7];   //[naLeptons]
   Float_t         aLeptons_isTrackerMuon[7];   //[naLeptons]
   Float_t         aLeptons_pixelHits[7];   //[naLeptons]
   Int_t           aLeptons_trackerLayers[7];   //[naLeptons]
   Int_t           aLeptons_pixelLayers[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTH[7];   //[naLeptons]
   Int_t           aLeptons_jetOverlapIdx[7];   //[naLeptons]
   Float_t         aLeptons_jetPtRatio[7];   //[naLeptons]
   Float_t         aLeptons_jetBTagCSV[7];   //[naLeptons]
   Float_t         aLeptons_jetDR[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetPtRatio[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetBTagCSV[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetDR[7];   //[naLeptons]
   Float_t         aLeptons_pfRelIso03[7];   //[naLeptons]
   Float_t         aLeptons_pfRelIso04[7];   //[naLeptons]
   Float_t         aLeptons_etaSc[7];   //[naLeptons]
   Float_t         aLeptons_eleExpMissingInnerHits[7];   //[naLeptons]
   Float_t         aLeptons_eleooEmooP[7];   //[naLeptons]
   Float_t         aLeptons_dr03TkSumPt[7];   //[naLeptons]
   Float_t         aLeptons_eleEcalClusterIso[7];   //[naLeptons]
   Float_t         aLeptons_eleHcalClusterIso[7];   //[naLeptons]
   Float_t         aLeptons_miniIsoCharged[7];   //[naLeptons]
   Float_t         aLeptons_miniIsoNeutral[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetPtRel[7];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetNDauChargedMVASel[7];   //[naLeptons]
   Float_t         aLeptons_uncalibratedPt[7];   //[naLeptons]
   Float_t         aLeptons_SF_IsoLoose[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IsoLoose[7];   //[naLeptons]
   Float_t         aLeptons_SF_IsoTight[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IsoTight[7];   //[naLeptons]
   Float_t         aLeptons_SF_IdCutLoose[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdCutLoose[7];   //[naLeptons]
   Float_t         aLeptons_SF_IdCutTight[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdCutTight[7];   //[naLeptons]
   Float_t         aLeptons_SF_IdMVALoose[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdMVALoose[7];   //[naLeptons]
   Float_t         aLeptons_SF_IdMVATight[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdMVATight[7];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunD4p3[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunD4p3[7];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunD4p2[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunD4p2[7];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunC[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunC[7];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT_RunD4p3[7];   //[naLeptons]
   Float_t         aLeptons_Efferr_HLT_RunD4p3[7];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT_RunD4p2[7];   //[naLeptons]
   Float_t         aLeptons_Efferr_HLT_RunD4p2[7];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT_RunC[7];   //[naLeptons]
   Float_t         aLeptons_Efferr_HLT_RunC[7];   //[naLeptons]
   ...
   Float_t         FatjetAK08ungroomed_mtrimmed[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_mfiltered[5];   //[nFatjetAK08ungroomed]
   ...
   Int_t           nTauGood;
   Int_t           TauGood_charge[10];   //[nTauGood]
   Int_t           TauGood_decayMode[10];   //[nTauGood]
   Int_t           TauGood_idDecayMode[10];   //[nTauGood]
   Int_t           TauGood_idDecayModeNewDMs[10];   //[nTauGood]
   Float_t         TauGood_dxy[10];   //[nTauGood]
   Float_t         TauGood_dz[10];   //[nTauGood]
   Int_t           TauGood_idMVA[10];   //[nTauGood]
   Int_t           TauGood_idMVArun2[10];   //[nTauGood]
   Float_t         TauGood_rawMVArun2[10];   //[nTauGood]
   Int_t           TauGood_idMVArun2dR03[10];   //[nTauGood]
   Float_t         TauGood_rawMVArun2dR03[10];   //[nTauGood]
   Int_t           TauGood_idMVANewDM[10];   //[nTauGood]
   Int_t           TauGood_idMVArun2NewDM[10];   //[nTauGood]
   Float_t         TauGood_rawMVArun2NewDM[10];   //[nTauGood]
   Int_t           TauGood_idCI3hit[10];   //[nTauGood]
   Int_t           TauGood_idCI3hitdR03[10];   //[nTauGood]
   Int_t           TauGood_idAntiMu[10];   //[nTauGood]
   Int_t           TauGood_idAntiE[10];   //[nTauGood]
   Int_t           TauGood_idAntiErun2[10];   //[nTauGood]
   Float_t         TauGood_isoCI3hit[10];   //[nTauGood]
   Float_t         TauGood_photonOutsideSigCone[10];   //[nTauGood]
   Int_t           TauGood_mcMatchId[10];   //[nTauGood]
   Int_t           TauGood_pdgId[10];   //[nTauGood]
   Float_t         TauGood_pt[10];   //[nTauGood]
   Float_t         TauGood_eta[10];   //[nTauGood]
   Float_t         TauGood_phi[10];   //[nTauGood]
   Float_t         TauGood_mass[10];   //[nTauGood]
   Int_t           TauGood_idxJetMatch[10];   //[nTauGood]
   Int_t           TauGood_genMatchType[10];   //[nTauGood]
   Int_t           nhJidx;
   ...
   Float_t         httCandidates_ptcal[3];   //[nhttCandidates]
   Float_t         httCandidates_etacal[3];   //[nhttCandidates]
   Float_t         httCandidates_phical[3];   //[nhttCandidates]
   Float_t         httCandidates_masscal[3];   //[nhttCandidates]
   ...
   Float_t         httCandidates_sjW1ptcal[3];   //[nhttCandidates]
   ...
   Float_t         httCandidates_sjW1masscal[3];   //[nhttCandidates]
   Float_t         httCandidates_sjW1mass[3];   //[nhttCandidates]
   Float_t         httCandidates_sjW1btag[3];   //[nhttCandidates]
   Float_t         httCandidates_sjW2ptcal[3];   //[nhttCandidates]
   ...
   Float_t         httCandidates_sjW2masscal[3];   //[nhttCandidates]
   Float_t         httCandidates_sjW2mass[3];   //[nhttCandidates]
   Float_t         httCandidates_sjW2btag[3];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWptcal[3];   //[nhttCandidates]
   ...
   Float_t         httCandidates_sjNonWmasscal[3];   //[nhttCandidates]
   ...
   Float_t         Jet_bTagWeightJESUp[18];   //[nJet]
   Float_t         Jet_bTagWeightJESDown[18];   //[nJet]
   Float_t         Jet_bTagWeightLFUp[18];   //[nJet]
   Float_t         Jet_bTagWeightLFDown[18];   //[nJet]
   Float_t         Jet_bTagWeightHFUp[18];   //[nJet]
   Float_t         Jet_bTagWeightHFDown[18];   //[nJet]
   Float_t         Jet_bTagWeightHFStats1Up[18];   //[nJet]
   Float_t         Jet_bTagWeightHFStats1Down[18];   //[nJet]
   Float_t         Jet_bTagWeightHFStats2Up[18];   //[nJet]
   Float_t         Jet_bTagWeightHFStats2Down[18];   //[nJet]
   Float_t         Jet_bTagWeightLFStats1Up[18];   //[nJet]
   Float_t         Jet_bTagWeightLFStats1Down[18];   //[nJet]
   Float_t         Jet_bTagWeightLFStats2Up[18];   //[nJet]
   Float_t         Jet_bTagWeightLFStats2Down[18];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Up[18];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Down[18];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Up[18];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Down[18];   //[nJet]
   Float_t         Jet_bTagWeight[18];   //[nJet]
   Float_t         Jet_btagCSVLSF[18];   //[nJet]
   Float_t         Jet_btagCSVLSF_Up[18];   //[nJet]
   Float_t         Jet_btagCSVLSF_Down[18];   //[nJet]
   Float_t         Jet_btagCSVMSF[18];   //[nJet]
   Float_t         Jet_btagCSVMSF_Up[18];   //[nJet]
   Float_t         Jet_btagCSVMSF_Down[18];   //[nJet]
   Float_t         Jet_btagCSVTSF[18];   //[nJet]
   Float_t         Jet_btagCSVTSF_Up[18];   //[nJet]
   Float_t         Jet_btagCSVTSF_Down[18];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF[18];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF_Up[18];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF_Down[18];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF[18];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF_Up[18];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF_Down[18];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF[18];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF_Up[18];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF_Down[18];   //[nJet]
   ...
   BaseTree(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~BaseTree() { }
