...
// Thu Feb 25 14:49:06 2016 by ROOT version 6.02/10
// from TChain tree/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         HLT_BIT_HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_BTagCSV0p72_v;
   Float_t         HLT_BIT_HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMET90_PFMHT90_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMET100_PFMHT100_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMET110_PFMHT110_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMET120_PFMHT120_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMET170_NoiseCleaned_v;
   Float_t         HLT_BIT_HLT_DiCentralPFJet55_PFMET110_NoiseCleaned_v;
   Float_t         HLT_BIT_HLT_PFHT350_PFMET100_NoiseCleaned_v;
   ...
   Float_t         HLT_BIT_HLT_PFHT750_4JetPt50_v;
   Float_t         HLT_BIT_HLT_PFHT800_v;
   ...
   Float_t         HLT_BIT_HLT_DiPFJetAve80_v;
   Float_t         HLT_BIT_HLT_DiPFJetAve140_v;
   Float_t         HLT_BIT_HLT_DiPFJetAve200_v;
   Float_t         HLT_BIT_HLT_DiPFJetAve260_v;
   Float_t         HLT_BIT_HLT_DiPFJetAve320_v;
   Float_t         HLT_hadronic;
   Float_t         HLT_BIT_HLT_PFHT400_SixJet30_BTagCSV0p55_2PFBTagCSV0p72_v;
   Float_t         HLT_BIT_HLT_PFHT450_SixJet40_PFBTagCSV0p72_v;
   Float_t         HLT_ttHhardonicLowLumi;
   Float_t         HLT_BIT_HLT_QuadJet45_TripleBTagCSV0p67_v;
   Float_t         HLT_BIT_HLT_QuadJet45_DoubleBTagCSV0p67_v;
   Float_t         HLT_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV0p67_v;
   Float_t         HLT_BIT_HLT_DoubleJet90_Double30_DoubleBTagCSV0p67_v;
   Float_t         HLT_HH4bAll;
   ...
   Float_t         HLT_BIT_HLT_DoubleEle24_22_eta2p1_WPLoose_Gsf_v;
   ...
   Float_t         HLT_BIT_HLT_Ele27_eta2p1_WPLoose_Gsf_HT200_v;
   Float_t         HLT_WenHbbLowLumi;
   Float_t         HLT_BIT_HLT_Ele32_eta2p1_WPLoose_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele32_eta2p1_WPLoose_Gsf_CentralPFJet30_BTagCSV07_v;
   Float_t         HLT_BIT_HLT_Ele27_eta2p1_WPLoose_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele27_eta2p1_WPLoose_Gsf_CentralPFJet30_BTagCSV07_v;
   Float_t         HLT_BIT_HLT_Ele105_CaloIdVT_GsfTrkIdT_v;
   Float_t         HLT_BIT_HLT_Ele45_CaloIdVT_GsfTrkIdT_PFJet200_PFJet50_v;
   Float_t         HLT_BIT_HLT_Ele27_WPLoose_Gsf_WHbbBoost_v;
   Float_t         HLT_BIT_HLT_Ele22_eta2p1_WPTight_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele22_eta2p1_WPLoose_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele23_WPLoose_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele27_WPLoose_Gsf_v;
   Float_t         HLT_BIT_HLT_Ele23_WPLoose_Gsf_WHbbBoost_v;
   ...
   Float_t         HLT_BIT_HLT_OldIsoMu18_v;
   Float_t         HLT_BIT_HLT_IsoTkMu18_v;
   Float_t         HLT_BIT_HLT_OldIsoTkMu18_v;
   ...
   Float_t         HLT_BIT_HLT_Ele30WP60_Ele8_Mass55_v;
   ...
   Float_t         FatjetCA15ungroomed_PFLepton_ptrel[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_z_ratio[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau_dot[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_mass_0[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_EnergyRatio_0[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_EnergyRatio_1[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_PFLepton_IP2D[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau_21[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_nSL[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_vertexNTracks[4];   //[nFatjetCA15ungroomed]
   ...
   Float_t         FatjetAK08ungroomed_tau_dot[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_SV_mass_0[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_SV_EnergyRatio_0[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_SV_EnergyRatio_1[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_PFLepton_IP2D[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_tau_21[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_nSL[5];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_vertexNTracks[5];   //[nFatjetAK08ungroomed]
   Int_t           nselLeptons;
   ...
   Int_t           nDiscardedJet;
   Int_t           DiscardedJet_id[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_puId[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCSV[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCMVA[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_rawPt[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JECUp[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JECDown[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_eta[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_phi[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_mass[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_idxFirstTauMatch[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagBDT[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagProb[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagBProb[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagSoftEl[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagSoftMu[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagnew[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCSVV0[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_chHEF[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_neHEF[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_chEmEF[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_neEmEF[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_chMult[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leadTrackPt[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPdgId[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPt[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPtRel[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPtRelInv[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaR[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaPhi[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaEta[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxMass[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxNtracks[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPt[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtx3DSig[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtx3DVal[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosX[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosY[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosZ[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_pullVectorPhi[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_pullVectorMag[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_qgl[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_ptd[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_axis2[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_mult[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_numberOfDaughters[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_btagIdx[11];   //[nDiscardedJet]
   Int_t           DiscardedJet_mcIdx[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt_reg[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt_regVBF[11];   //[nDiscardedJet]
   Float_t         DiscardedJet_blike_VBF[11];   //[nDiscardedJet]
   ...
   Float_t         SubjetAK08softdrop_pt[9];   //[nSubjetAK08softdrop]
   Float_t         SubjetAK08softdrop_eta[9];   //[nSubjetAK08softdrop]
   Float_t         SubjetAK08softdrop_phi[9];   //[nSubjetAK08softdrop]
   Float_t         SubjetAK08softdrop_mass[9];   //[nSubjetAK08softdrop]
   Float_t         SubjetAK08softdrop_btag[9];   //[nSubjetAK08softdrop]
